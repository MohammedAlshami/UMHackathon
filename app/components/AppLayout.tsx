  ...
  return (
    <>
      <body className="bg-gray-50 dark:bg-slate-900 overflow-y-hidden"  >
        <header className="sticky z-50 top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] w-full bg-white border-b text-sm py-2.5 sm:py-4 lg:ps-64 dark:bg-gray-800 dark:border-gray-700">
          <nav
