            ...
            <div className="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
                ...
                <div className="mb-10 border bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div className="flex justify-end items-center gap-x-2 sm:px-7 dark:border-gray-700 pt-8">
                        <a className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="./dashboard">Cancel</a>
